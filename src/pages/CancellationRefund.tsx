          ...
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            <CardContent className="pt-6">
              ...
              <p className="text-foreground/80 leading-relaxed">
                At poshlane, we want you to be completely satisfied with your order. 
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <CardContent className="space-y-3 text-foreground/80 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Email: support@poshlane.app</li>
              </ul>
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <CardContent className="space-y-3 text-foreground/80 leading-relaxed">
              <p>
                ...
                the matter by contacting our management team at support@poshlane.app with 
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <CardContent className="space-y-3 text-foreground/80 leading-relaxed">
              ...
              <ul className="list-none space-y-2 mt-4">
                ...
                <li><strong>Email:</strong> support@poshlane.app</li>
